  ...
  return (
    <Grid>
      <Flex flexDirection="column" style={{ gridArea: 'a' }}>
        ...
        {circulatingSupply ? (
          <Balance decimals={0} lineHeight="1.1" fontSize="24px" bold value={4500000000000000000000000} />
        ) : (
      ...
      <StyledColumn noMobileBorder style={{ gridArea: 'b' }}>
        ...
        <Balance decimals={0} lineHeight="1.1" fontSize="24px" bold value={5500000000000000000000000} />
      </StyledColumn>
      <StyledColumn noMobileBorder style={{ gridArea: 'c' }}>
        <Text color="textSubtle">{t('Total supply')}</Text>
        {cakeSupply ? (
          <Balance decimals={0} lineHeight="1.1" fontSize="24px" bold value={10000000000000000000000000} />
        ) : (
          <>
            <div ref={observerRef} />
            <Skeleton height={24} width={126} my="4px" />
...
export default BnbTigerDataRow
